...
public class FuchimiGameRulesTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(hand2 + "beats" + hand2 + "?" + hand2.beats(hand3));
		System.out.println(hand3 + "beats" + hand2 + "?" + hand3.beats(hand1));
		System.out.println(hand3 + "beats" + hand2 + "?" + hand3.beats(hand2));
		System.out.println(hand3 + "beats" + hand2 + "?" + hand3.beats(hand3));
	}
